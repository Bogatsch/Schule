...
assert.match(html, /styles\.css\?v=28/, 'Versionskennung gegen veraltetes Player-CSS fehlt');
assert.match(html, /app\.js\?v=28/, 'Versionskennung gegen veraltete Player-Logik fehlt');
